      ...
      <div className="detail-head">
        ...
        <div className="detail-actions">
          ...
          {canWrite && entryMode === "edit" ? (
            <>
              <button type="submit" form={editFormId} className="icon-button" aria-label="Save entry">
                <Check size={16} />
              </button>
              <button type="button" className="ghost-button icon-button" onClick={resetEntryEdit} aria-label="Cancel edit">
                <X size={16} />
              </button>
            </>
          ) : null}
