...
const RATING_ICON_SPECS = [
  ...
  { value: "hop", label: "Hops", group: "Drinks" },
  { value: "hop-off", label: "No hops", group: "Drinks" },
  { value: "cup-soda", label: "Cup soda", group: "Drinks" },
  { value: "milk", label: "Milk", group: "Drinks" },
  { value: "milk-off", label: "No milk", group: "Drinks" },
  { value: "beef", label: "Beef", group: "Food" },
  { value: "beef-off", label: "No beef", group: "Food" },
  { value: "bone", label: "Bone", group: "Food" },
  { value: "cake", label: "Cake", group: "Food" },
  { value: "cake-slice", label: "Cake slice", group: "Food" },
  { value: "candy-off", label: "No candy", group: "Food" },
  { value: "citrus", label: "Citrus", group: "Food" },
  { value: "cooking-pot", label: "Cooking pot", group: "Food" },
  { value: "dessert", label: "Dessert", group: "Food" },
  ...
  { value: "egg-off", label: "No egg", group: "Food" },
  { value: "fish-off", label: "No fish", group: "Food" },
  { value: "grape", label: "Grape", group: "Food" },
  { value: "ham", label: "Ham", group: "Food" },
  { value: "hamburger", label: "Hamburger", group: "Food" },
  { value: "lollipop", label: "Lollipop", group: "Food" },
  { value: "nut", label: "Nut", group: "Food" },
  ...
  { value: "vegan", label: "Vegan", group: "Food" },
  { value: "wheat", label: "Wheat", group: "Food" },
  { value: "wheat-off", label: "Wheat off", group: "Food" },
